...
export function Modal({ isOpen, onClose, title, children, size = 'md' }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center p-0 sm:p-4 animate-fade-in">
      ...
      />
      <div
        className={`relative bg-white dark:bg-gray-800 shadow-2xl ${sizes[size]} w-full max-h-[92dvh] flex flex-col animate-scale-in border border-gray-200 dark:border-gray-700 rounded-t-2xl sm:r-card`}
      >
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 rounded-t-2xl flex-shrink-0">
          ...
          <button
            onClick={onClose}
            className="p-2 r-control hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-200 hover:rotate-90 group"
          >
