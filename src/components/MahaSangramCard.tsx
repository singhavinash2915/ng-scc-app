...
export function MahaSangramCard({ matches }: Props) {
  ...
  return (
    <div className="relative overflow-hidden r-card shadow-xl text-white"
      ...
      <div className="relative p-5">
        <div className="flex items-center justify-between gap-3">
          <span className="inline-flex items-center gap-1.5 t-micro font-black uppercase tracking-[2.5px] text-white/70">
            <Trophy className="w-3 h-3" /> SCC MahaSangram
          </span>
          <a href={MAHASANGRAM.cricHeroesUrl} target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-1 t-micro font-bold text-white/60 hover:text-white">
        ...
        <p className="text-center t-meta text-white/45 mt-3">
          {record.played > 0
        ...
        <Link to="/scc-mahasangram"
          className="mt-4 flex items-center justify-center gap-1.5 r-card bg-white/12
                     border border-white/20 py-2.5 t-meta font-black hover:bg-white/20 transition-colors">
