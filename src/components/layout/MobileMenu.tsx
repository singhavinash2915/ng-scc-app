...
import { X, UserPlus, Settings, Shield, Lock, LogOut, LayoutDashboard, Users, Calendar, Wallet, Info, Receipt, Megaphone, Landmark, Brain, ListOrdered, Award, FileText, Sparkles, Trophy, BookOpen, ExternalLink, Rocket, Gavel } from 'lucide-react';
        ...
        <div className="fixed right-0 top-0 bottom-0 w-72 bg-white dark:bg-gray-800 shadow-xl animate-slideIn flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-2">
            ...
            <a
              ...
              className="flex items-center gap-3 px-4 py-3 r-card bg-primary-50 dark:bg-primary-900/20 border border-primary-200 dark:border-primary-800 text-primary-700 dark:text-primary-400 text-sm font-medium hover:bg-primary-100 dark:hover:bg-primary-900/30 transition"
              onClick={onClose}
            >
