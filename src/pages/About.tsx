  ...
  return (
    <div>
      ...
      <div className="p-4 lg:p-8 space-y-6 max-w-6xl mx-auto">
        ...
        {/* ── HERO ────────────────────────────────────────────────────────── */}
        <div className="glass r-card relative overflow-hidden">
          <div className="absolute inset-0"
               style={{ background: 'radial-gradient(700px circle at 88% -30%, rgba(16,185,129,0.16), transparent 62%)' }} />
          <div className="absolute inset-0 opacity-[0.05] dark:opacity-[0.06] [filter:invert(1)] dark:[filter:none]" style={{
          ...
          <div className="absolute inset-x-0 top-0 h-[3px] bg-gradient-to-r from-emerald-400 via-emerald-300 to-transparent" />
          ...
          <div className="relative p-6 lg:p-12 text-center">
            ...
            <p className="text-emerald-600 dark:text-emerald-300/80 text-sm lg:text-base font-bold uppercase tracking-[3px] mt-3">
              Pune · Est. 2024 · Champions Play Here
            </p>
            <p className="text-slate-400 dark:text-white/45 text-base lg:text-lg max-w-2xl mx-auto mt-6 leading-relaxed">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-8">
              <StatPill value={members.length} label="Members" color="text-sky-600 dark:text-sky-300" />
              <StatPill value={completedMatches.length} label="Matches" color="text-emerald-600 dark:text-emerald-300" />
              <StatPill value={`${winRate}%`} label="Win Rate" color="text-amber-600 dark:text-amber-300" />
              <StatPill value={totalMOMs} label="MOM Awards" color="text-rose-600 dark:text-rose-300" />
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          <div className="glass r-card relative overflow-hidden lg:col-span-2 p-6 lg:p-7">
          <div className="absolute inset-x-0 top-0 h-[3px] bg-emerald-400/70" />
            ...
            <h2 className="text-emerald-600 dark:text-emerald-300/80 t-micro font-bold uppercase tracking-[2px] flex items-center gap-2">
              <Heart className="w-3.5 h-3.5" fill="currentColor" />
              Our Story
            </h2>
            <h3 className="text-2xl lg:text-3xl font-black text-slate-900 dark:text-white mt-2 tracking-tight">Built by players, for players</h3>
            <div className="mt-4 space-y-3 text-slate-500 dark:text-white/60 text-sm lg:text-base leading-relaxed">
              <p>
              ...
              <p>
                ...
                From <span className="text-emerald-600 dark:text-emerald-300 font-semibold">match-day polls</span> to{' '}
                <span className="text-amber-600 dark:text-amber-300 font-semibold">Man of the Match awards</span>, this app
                is how we keep the team organized, the finances clean, and the rivalry friendly.
              </p>
              <p className="text-slate-400 dark:text-white/45 italic">
          ...
          <div className="space-y-3">
            ...
            <ValueCard icon={<TrendingUp className="w-4 h-4" />} label="Get Better Together"
              ...
              rule="bg-amber-400/70" />
          </div>
        </div>

        {/* ── BY THE NUMBERS ───────────────────────────────────────────────── */}
        <div>
          <h2 className="t-meta font-bold text-slate-400 dark:text-white/40 uppercase tracking-[2px] mb-3 flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            <BigStat icon={<Users className="w-4 h-4" />} value={activeCount} label="Active Members"
              rule="bg-sky-400/70" accent="text-sky-600 dark:text-sky-300" />
            <BigStat icon={<Calendar className="w-4 h-4" />} value={completedMatches.length} label="Matches Played"
              rule="bg-emerald-400/70" accent="text-emerald-600 dark:text-emerald-300" />
            <BigStat icon={<Zap className="w-4 h-4" />} value={totalRuns} label="Total Runs Scored"
              rule="bg-amber-400/70" accent="text-amber-600 dark:text-amber-300" />
            <BigStat icon={<Shield className="w-4 h-4" />} value={totalWkts} label="Total Wickets"
              rule="bg-rose-400/70" accent="text-rose-600 dark:text-rose-300" />
          </div>
        </div>
        ...
        <Card className="p-6 lg:p-7">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="t-micro font-bold uppercase tracking-[2px] text-slate-400 dark:text-white/40">
              The SCC App
            </span>
          </div>
          ...
          <p className="text-sm text-slate-400 dark:text-white/45 mt-2">
          ...
          <div className="mt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              ...
              <div key={f.title} className="r-card border border-gray-100 dark:border-gray-800 p-4 hover:border-primary-300 dark:hover:border-primary-700 transition-colors">
                ...
                <p className="text-xs text-slate-400 dark:text-white/45 mt-1 leading-relaxed">{f.text}</p>
              </div>
            ))}
          </div>
        </Card>
        ...
        <Link to="/requests" className="block group">
          <div className="relative overflow-hidden r-card shadow-xl">
            ...
            <div className="relative p-6 lg:p-8 flex items-center gap-5 flex-wrap">
              <Card className="flex-shrink-0 w-14 h-14 bg-white/15 backdrop-blur-sm flex items-center justify-center border-slate-200 dark:border-white/20">
                <Send className="w-7 h-7 text-slate-900 dark:text-white" />
              </Card>
              <div className="flex-1 min-w-0">
                <p className="text-emerald-600 dark:text-emerald-300 t-micro font-bold uppercase tracking-[2px]">Join SCC</p>
                <h3 className="text-xl lg:text-2xl font-black text-slate-900 dark:text-white mt-1">Want to play with us?</h3>
                <p className="text-emerald-100/70 text-sm mt-1">Submit a membership request — we'd love to have you on the squad.</p>
              </div>
              <ChevronRight className="w-6 h-6 text-slate-500 dark:text-white/70 group-hover:translate-x-1 transition-transform flex-shrink-0" />
            </div>
          </div>
        </Link>
                ...
                <div key={s.id} className="r-card border border-gray-200 dark:border-gray-700 p-5 bg-white dark:bg-gray-900 flex items-center gap-4">
                  {s.logo_url ? (
                    ...
                    <div className="w-16 h-16 r-card bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 flex items-center justify-center flex-shrink-0">
                      <Building2 className="w-7 h-7 text-slate-400 dark:text-white/45" />
                    </div>
                  )}
                  <div className="flex-1 min-w-0">
                    <h3 className="font-black text-gray-900 dark:text-white text-base truncate">{s.name}</h3>
                    {s.tagline && <p className="text-sm text-slate-400 dark:text-white/45 truncate">{s.tagline}</p>}
                    {s.member && <p className="text-xs text-slate-400 dark:text-white/45 mt-0.5">SCC Member · {s.member.name}</p>}
                  </div>
                  {s.website_url && (
                    <a href={s.website_url} target="_blank" rel="noopener noreferrer"
                      ...
                      <ExternalLink className="w-4 h-4 text-slate-400 dark:text-white/40 hover:text-primary-500" />
                    </a>
                  )}
                </div>
              ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card className="p-5">
            <h3 className="t-micro font-bold text-slate-400 dark:text-white/45 uppercase tracking-[1.5px] mb-3 flex items-center gap-1.5">
              <Phone className="w-3 h-3" /> Reach Out
            </h3>
            <div className="space-y-2 text-sm">
              <a href="mailto:singhopstech@gmail.com" className="flex items-center gap-3 text-gray-700 dark:text-white/60 hover:text-primary-600 dark:hover:text-primary-400">
                <Mail className="w-4 h-4 text-slate-400 dark:text-white/45" />
                <span>singhopstech@gmail.com</span>
              </a>
              <a href="tel:+918888546860" className="flex items-center gap-3 text-gray-700 dark:text-white/60 hover:text-primary-600 dark:hover:text-primary-400">
                <Phone className="w-4 h-4 text-slate-400 dark:text-white/45" />
                <span>+91 88885 46860</span>
              </a>
              <a href="https://sangriacricket.club" target="_blank" rel="noopener noreferrer"
                 className="flex items-center gap-3 text-gray-700 dark:text-white/60 hover:text-primary-600 dark:hover:text-primary-400">
                <Globe className="w-4 h-4 text-slate-400 dark:text-white/45" />
                <span>sangriacricket.club</span>
              </a>
              <div className="flex items-center gap-3 text-gray-700 dark:text-white/60">
                <MapPin className="w-4 h-4 text-slate-400 dark:text-white/45" />
            ...
            <div className="grid grid-cols-2 gap-2.5">
              <a href="https://cricheroes.in/team-profile/7927431/sangria-cricket-club" target="_blank" rel="noopener noreferrer"
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="t-micro text-slate-400 dark:text-white/45">Live scorecards</p>
                </div>
                <ExternalLink className="w-3 h-3 text-slate-400 dark:text-white/45" />
              </a>
              <a href="https://www.instagram.com/sangriacricket" target="_blank" rel="noopener noreferrer"
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="t-micro text-slate-400 dark:text-white/45">Match highlights</p>
                </div>
                <ExternalLink className="w-3 h-3 text-slate-400 dark:text-white/45" />
              </a>
            </div>
        ...
        <div className="text-center py-6">
          ...
          <p className="t-micro text-slate-400 dark:text-white/40 mt-1">
...
function StatPill({ value, label, color }: { value: string | number; label: string; color: string }) {
  return (
    <Card className="bg-white/5 border-slate-200 dark:border-white/10 backdrop-blur-sm px-4 py-3">
...
// Colour as an accent rather than a fill — the same shape the records and the
// season stars use, so a card means the same thing wherever it appears.
function ValueCard({ icon, label, text, rule }: { icon: React.ReactNode; label: string; text: string; rule: string }) {
  return (
    <div className="glass r-card relative overflow-hidden p-4">
      <div className={`absolute inset-x-0 top-0 h-[3px] ${rule}`} />
      <div className="flex items-center gap-2 text-slate-900 dark:text-white relative">
        {icon}
        <span className="t-micro font-bold uppercase tracking-[1.5px]">{label}</span>
      </div>
      <p className="relative text-sm text-slate-500 dark:text-white/60 mt-2 leading-relaxed">{text}</p>
    </div>
  );
}

function BigStat({ icon, value, label, rule, accent }: { icon: React.ReactNode; value: string | number; label: string; rule: string; accent: string }) {
  return (
    <div className="glass r-card relative overflow-hidden p-5">
      ...
      <p className="text-3xl lg:text-4xl font-black text-slate-900 dark:text-white tabular-nums relative leading-none">{value}</p>
    </div>
  );
}

function PillarCard({ icon, title, value, subtitle, rule, accent }: { icon: React.ReactNode; title: string; value: string; subtitle: string; rule: string; accent: string }) {
  return (
    <div className="glass r-card relative overflow-hidden p-5">
      <div className={`absolute inset-x-0 top-0 h-[3px] ${rule}`} />
      <div className={`flex items-center gap-1.5 mb-2 relative ${accent}`}>
      ...
      <p className="text-xl lg:text-2xl font-black text-slate-900 dark:text-white tracking-tight relative">{value}</p>
      <p className="text-xs text-slate-400 dark:text-white/45 mt-1 relative">{subtitle}</p>
    </div>
  );
}
